...
class MetrolookTemplate extends BaseTemplate {
	...
	public function execute() {
		global $wgVectorUseIconWatch, $wgMetrolookLogo, $wgMetrolookSearchBar, $wgMetrolookDownArrow,
		$wgMetrolookLine, $wgMetrolookUploadButton, $wgMetrolookSiteName, $wgMetrolookBartile,
		$wgMetrolookTile1, $wgMetrolookTile2, $wgMetrolookTile3, $wgMetrolookTile4, $wgMetrolookTile5,
		$wgMetrolookTile6, $wgMetrolookTile7, $wgMetrolookTile8, $wgMetrolookTile9, $wgMetrolookTile10,
		$wgMetrolookMobile;
