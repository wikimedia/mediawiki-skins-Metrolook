...
class MetrolookHooks {
	 ...
	 *
	 * This method is public to allow other extensions that use Metrolook to use the
	 * same configuration as Metrolook itself
	 *
	 ...
	 * GetPreferences hook
	 * 
	 * Adds Metrolook-releated items to the preferences
	 * 
	 ...
	 * 
	 * Adds enabled/disabled switches for Metrolook modules
	 */
